        ...
        <div>
            ...
            <div className="flex flex-col p-2 mt-3 border-4 gap-10 border-gray-400 rounded-xl w-full ">
                <div className="flex flex-col gap-3 p-5">
                    <p className="text-gray-500 text-xl">Upload Image </p>
                    <label
                        className={`flex flex-col justify-center border-2 border-dashed rounded-xl p-5 text-center cursor-pointer
