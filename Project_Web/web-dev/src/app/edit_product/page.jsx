...
export default function edit_product() {
    const {imagefile} = useContext(ShopContext);
    ...
    return (
        <div className="flex flex-col p-10 mt-10 items-center">
            {/* Title */}
            ...
            <form className="mt-10 w-3/4 flex flex-col justify-center " onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col gap-3 w-1/2">
                        ...
                        <div className="flex flex-col p-5 border-4 gap-10 border-gray-400 rounded-xl w-full">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <textarea className="bg-gray-200 border-2 rounded-xl p-3 h-80" name="p_detail" value={detail} onChange={(e)=>setDetail(e.target.value)}></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex w-full mt-10">
                    ...
                    <div className="flex flex-col gap-3 w-1/3 ml-9">
                        <div className="flex items-center justify-start">
                        ...
                        <div className="flex flex-col p-5 border-4 gap-10 border-gray-400 rounded-xl w-3/4">
                            <div className="flex flex-col gap-3">
                                ...
                                <input className="bg-gray-200 border-2 rounded-xl p-3" onChange={(e)=>setBrand(e.target.value)} type="text" name="brand_name" />
                            </div>
                        </div>
                    </div>
                </div>

                <div className="flex justify-end items-end gap-14 ml-[1000px] mt-12">
