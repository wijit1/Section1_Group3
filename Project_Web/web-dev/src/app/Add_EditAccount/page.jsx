     ...
     <div>
         <div className="max-w-5xl mx-auto">
             ...
             <div className="flex items-center gap-4 mb-8">
                 ...
                 <h1 className="text-7xl font-bold">ADD &amp; Edit Account</h1>
             </div>
             {/* Form Container */}
      ...
      <br> Profile แบบนอกกรอบ */}
                     <div className="bg-white p-6 rounded-xl ring-offset-2 ring-2 ring-black">
                         ...
                         <div className="space-y-4">
                             ...
                             <button className="text-gray-500 text-sm">Change</button>
                             <div className="space-y-4">
                                 <div>
      ...
      <br> Information แบบนอกกรอบ */}
                     <div className="bg-white p-6 rounded-xl ring-offset-2 ring-2 ring-black">
                         <div className="flex items-center gap-2 mb-6">
                             ...
                             <img src="picture/photo-book.png" width={25} />
                         </div>
                         <div className="space-y-4">
                             <div>
                                 ...
                                 <div className="relative">
                                     ...
                                     <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
                                         <img src="picture/mail.png" width={25} />
                                     </div>
                                 </div>
                                 <div>
                                     <br />
                                     ...
                                     <div className="relative">
                                         <input type="text" className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                                         <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
                                             <img src="picture/address.png" width={25} />
                                         </div>
                                     </div>
                                     <div>
                                         <br />
                                         ...
                                         <div className="relative">
                                             ...
                                             <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
                                                 <img src="picture/phone-call.png" width={25} />
                                             </div>
                                         </div>
                                     </div>
                                 </div>
